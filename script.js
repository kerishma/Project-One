...
// loop for 'surprise me' button
function randomRestaurantCards(data) {
    let places = data.businesses;
...
// adding function for 'surprise me button'
